...
def sis(n, p, g, burn, tar_cov, dim, mcmc_type='vMFNM', k_init=1, seed=None, initial_sample=None):
    ...
    return pf, number_tempering, sigmak[0:m + 2], number_fun_eval, computational_cost, accrate[0:len(accrate)-1], uk, gk
