...
# set up problems
dims = [50,2]
problem_list =[ree.make_fujita_rackwitz(d) for d in dims] + [ree.make_linear_problem(d)(d) for d in dims] 
# set up other parameters

sample_sizes =[1000, 2000, 3000, 4000, 5000, 6000]
num_runs = 200

other = ["Average Estimate", "Root Weighted Average Estimate", "VAR Weighted Average Estimate","CVAR"]
